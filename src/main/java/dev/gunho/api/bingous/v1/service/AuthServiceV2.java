...
public class AuthServiceV2 {
     ...
     * 이메일 인증코드 발송
     */
    public Mono<Boolean> sendEmailVerifyCode(EmailVerify.Request request) {
     ...
     * 이메일 인증코드 확인
     */
    public Mono<EmailVerify.VerifyCodeResponse> verifyEmailCode(EmailVerify.VerifyCodeRequest request) {
        log.info("verifyEmailCode - Email: {}, Code: {}", request.email(), request.code());

        EmailVerify.VerifyCodeResponse response = EmailVerify.VerifyCodeResponse
                .builder()
                .verified(false)
     ...
     * 회원가입
     */
    public Mono<SignUp.Response> signUp(SignUp.Request request) {
        log.info("signUp called - ID: {}, Email: {}", request.id(), request.email());
        SignUp.Response response = SignUp.Response
                .builder()
                .success(false)
     ...
     * 로그인
     */
    public Mono<SignIn.Response> signIn(SignIn.Request request, ServerHttpRequest httpRequest) {
